  ...
  return(
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path 
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.23 0H1.77C.79 0 0 .79 0 1.77v20.46c0 .98.79 1.77 1.77 1.77h20.46c.98 0 1.77-.79 1.77-1.77V1.77c0-.98-.79-1.77-1.77-1.77zM7.18 20.45H3.6V9.18h3.58v11.27zM5.39 7.82c-1.22 0-2.2-.99-2.2-2.2 0-1.21.98-2.2 2.2-2.2s2.2.99 2.2 2.2c0 1.21-.98 2.2-2.2 2.2zm15.04 12.63h-3.58v-5.5c0-1.3-.47-2.19-1.63-2.19-1.22 0-1.94.82-1.94 2.19v5.5H9.69V9.18h3.58v1.63c.5-.92 1.63-1.63 3.32-1.63 3.58 0 4.22 2.36 4.22 6.55v5.5z" 
      />
  </svg>
  )
}
...
export const socialMediaProfiles = [
  ...
  { title: 'GitHub', href: 'https://github.com', icon: GitHubIcon },
    { title: 'LinkedIn', href: 'https://www.linkedin.com/company/azkashine-software-services-pvt-ltd', icon: LinkedinIcon },
